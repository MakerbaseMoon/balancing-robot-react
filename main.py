...
def main():
    files = [ 
        { 'filename': 'bundle.js',  'filepath': 'build/bundle.js'  },
        { 'filename': 'styles.css', 'filepath': 'build/styles.css' }
    ]
...
def open_public_files():
    ...
    remove_files = ['bundle.js.LICENSE.txt', 'index.html', 'bundle.js', 'bundle.js.gz', 'styles.css', 'styles.css.gz']
